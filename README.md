...
- Criada uma API Node.js simples com rotas para listar e buscar produtos.
- Adicionados testes automatizados para validar o comportamento da API.
- Criado `Dockerfile` para gerar uma imagem do serviço.
- Configurado workflow de CI/CD no GitHub Actions para executar testes, build da imagem Docker e publicação no GHCR.
- Adicionada etapa simulada de deploy em staging no pipeline.
